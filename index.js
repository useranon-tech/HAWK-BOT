...
//
const BotName = 'HAWK-BOT';
const instagramlu = 'https://www.instagram.com/dias_hndrk';
const whatsapplu = '+6281211233903';
const kapanbotaktif = '19.30-23.00 AM';
const grupch1 = 'https://chat.whatsapp.com/HgfzMdZSMJOL7rXHdn3mR0';
const grupch2 = 'https://chat.whatsapp.com/Cj7k0JeEpDVLmGtgFmLK3I';
const merenung = 'https://www.instagram.com/dias_hndrk';
//
const
{
   WAConnection,
...
axios.get(`https://st4rz.herokuapp.com/api/yta?url=${teks}`).then((res) => {
    let hasil = `Audio Di Temukan, Silahkan klik link dan download hasilnya\n👇👇👇👇👇👇👇👇👇\n\nJudul: ${res.data.title}\n\nUkuran audio: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://st4rz.herokuapp.com/api/ytv?url=${teks}`).then((res) => {
    let hasil = `Video Di  Temukan, Silahkan klik link dan download hasilnya\n👇👇👇👇👇👇👇👇👇\n\nJudul: ${res.data.title}\n\nUkuran video: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://mhankbarbar.herokuapp.com/api/twit?url=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
    let hasil = `Download sendiri melalui link yang di sediakan ya, takut servernya down xixi..\n\nJudul: ${res.data.title}\n\nSize: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
conn.sendMessage(id, 'cari Dias kak?, chat dia aja kak wa.me/+6281211233903?text=kak+aku+kangen+wkwkwk' ,MessageType.text);
}
else if (text == 'Assalamualaikum'){
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? ketik #help untuk menampilkan bot' ,MessageType.text);
}
else if (text == 'p'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? ketik #help untuk menampilkan bot' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? ketik #help untuk menampilkan bot' ,MessageType.text);
}
...
conn.sendMessage(id, 'CARI DIAS KAK?, INI CHAT DIA AJA wa.me/+6281211233903?text=kak+aku+kangen+wkwkwk' ,MessageType.text);
}
else if (text == 'woy'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? ketik #help untuk menampilkan bot' ,MessageType.text);
}
...
conn.sendMessage(id, 'Hmm Dias yah?, kalo mau kenalan sama dia chat nomer ini wa.me/+6281211233903' ,MessageType.text);
}
else if (text == 'Dias'){
conn.sendMessage(id, 'Hmm Dias yah?, kalo mau kenalan sama dia chat nomer ini wa.me/+6281211233903' ,MessageType.text);
}
else if (text == 'thanks'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan >_' ,MessageType.text);
}
else if (text == 'Thanks'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan >_' ,MessageType.text);
}
